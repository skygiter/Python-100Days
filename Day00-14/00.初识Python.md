...
2. 学习使用turtle在屏幕上绘制图形。
    ...
    turtle.mainloop()  
    ```
    # 上面代码输出一个红色正方形,turtle.mainloop()无任何效果，查资料应该是循环绘制
    # tips:alt+P 输入上条语句    alt+N  输入下条语句

本文基于github开源项目 
https://github.com/jackfrued/Python-100-Days.git
本人以此项目入门Python,此系列文章谨以记录学习历程及分享给需要的朋友
